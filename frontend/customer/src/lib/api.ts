...
export const SEED_FUNCTIONS: FunctionType[] = [
  {
    id: "fn-1",
    name: "Grand Telugu Wedding & Reception (పెళ్ళి & రిసెప్షన్)",
    slug: "royal-weddings",
  ...
  {
    id: "fn-2",
    name: "Sangeeth, Mehendi & Haldi Soirée (సంగీత్ & మెహెందీ)",
  ...
  {
    id: "fn-3",
    name: "Gruhapravesam & Satyanarayana Vratham (గృహప్రవేశం & పూజలు)",
  ...
  {
    id: "fn-4",
    name: "Seemantham & Baby Shower (సీమంతం వేడుక)",
  ...
  {
    id: "fn-5",
    name: "Half Saree & Dhothi Ceremony (లంగా ఓణీ & పంచెల వేడుక)",
...
export const SEED_OFFERINGS: CateringOffering[] = [
  {
    id: "off-1",
    name: "Royal Banti Bhojanam (బాంతి భోజనం - Plantain Leaf Service)",
    slug: "banti-bhojanam",
  ...
  {
    id: "off-3",
    name: "Live Interactive Cooking Theatres (లైవ్ కౌంటర్లు)",
    slug: "live-stations",
  ...
  {
    id: "off-4",
    name: "High-Tea & Savory Soirée (హై-టీ స్పెషల్)",
    slug: "high-tea-canape",
    description: "Artisanal filter coffees, Irani chai, Osmania biscuits, Mirchi bajjis, canapés, and fresh mithai bites.",
...
export const SEED_CATEGORIES: MenuCategory[] = [
  { id: "cat-1", name: "Welcome Elixirs & Traditional Coolers (స్వాగత పానీయాలు)", slug: "welcome-drinks", description: "Refreshing arrival drinks and herbal digestifs", sort_order: 1, is_active: true },
  { id: "cat-2", name: "Traditional Veg Starters & Bajjis (శాఖాహార స్టార్టర్స్)", slug: "starters-veg", description: "Crisp clay oven & tawa fried appetizers", sort_order: 2, is_active: true },
  { id: "cat-3", name: "Royal Non-Veg Starters & Vepudu (మాంసాహార స్టార్టర్స్)", slug: "starters-nonveg", description: "Spicy coastal seafood, chicken & mutton fries", sort_order: 3, is_active: true },
  { id: "cat-4", name: "Hyderabadi Biryanis & Flavored Rices (బిర్యానీ & అన్నం)", slug: "biryani-rice", description: "Dum biryanis, bagara rice, pulihora & pulaos", sort_order: 4, is_active: true },
  { id: "cat-5", name: "Authentic Curries, Kooras & Pulusu (కూరలు & పులుసులు)", slug: "gravies-curries", description: "Gutti vankaya, gongura curries and royal gravies", sort_order: 5, is_active: true },
  { id: "cat-6", name: "Pappu, Sambar, Ulavacharu & Charu (పప్పు & చారు)", slug: "dals-rasam", description: "Comforting dals, traditional stews and pepper rasam", sort_order: 6, is_active: true },
  { id: "cat-7", name: "Podis, Pachadis & Accompaniments (పొడులు & పచ్చళ్ళు)", slug: "podis-pachadis", description: "Gongura pachadi, avakaya, kandi podi and fryums", sort_order: 7, is_active: true },
  { id: "cat-8", name: "Traditional Sweets & Hyderabadi Desserts (మిఠాయిలు & స్వీట్స్)", slug: "sweets-desserts", description: "Pootharekulu, bobbatlu, double ka meetha & kulfi", sort_order: 8, is_active: true },
  { id: "cat-9", name: "Interactive Live Counters (ప్రత్యేక లైవ్ కౌంటర్లు)", slug: "live-counters", description: "Live Dosa, Pesarattu, Chaat & Jalebi stations", sort_order: 9, is_active: true },
];
...
export const SEED_MENU_ITEMS: MenuItem[] = [
  ...
  // 6. Pappu, Sambar & Rasam
  {
    ...
    description: "The auspicious opening course of every Telugu wedding: thick yellow toor dal mash topped with streaming hot ghee.",
    dietary_type: "VEG",
    image_url: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=600&q=80",
    sort_order: 1,
    is_active: true,
  ...
  },
  {
    id: "dish-30",
    category_id: "cat-6",
    name: "Ulavacharu with Fresh Cream (మీగడ ఉలవచారు)",
  ...
  },
  {
    ...
    dietary_type: "VEGAN",
    image_url: "https://images.unsplash.com/photo-1548946526-f69e2424cf45?auto=format&fit=crop&w=600&q=80",
    sort_order: 5,
    is_active: true,
  ...
  // 7. Podis, Pachadis & Accompaniments
  {
    id: "dish-33",
    category_id: "cat-7",
    name: "Andhra Gongura Pachadi (గోంగూర పచ్చడి)",
  ...
  },
  {
    id: "dish-34",
    category_id: "cat-7",
    name: "Kandi Podi with Ghee (కంది పొడి)",
...
export const SEED_PACKAGES: PackageDetail[] = [
  {
    id: "pkg-1",
    name: "Sri Krishna Devaraya Pelli Bhojanam (శ్రీ కృష్ణదేవరాయ పెళ్ళి భోజనం)",
  ...
  {
    id: "pkg-2",
    name: "Hyderabadi Shahi Dawat (హైదరాబాదీ షాహీ నాన్-వెజ్ దావత్)",
  ...
  {
    id: "pkg-3",
    name: "Godavari & Rayalaseema Ruchulu (గోదావరి & రాయలసీమ రుచులు)",
  ...
  {
    id: "pkg-4",
    name: "Gruhapravesam & Puja Sattvic Thali (గృహప్రవేశం సాత్విక భోజనం)",
  ...
  {
    id: "pkg-5",
    name: "Srimantham (Seemantham) 7-Rice & Sweet Spread (సీమంతం 7 రకాల విందు)",
  ...
  {
    id: "pkg-6",
    name: "Modern Sangeeth Live Counter Extravaganza (సంగీత్ లైవ్ కౌంటర్లు)",
